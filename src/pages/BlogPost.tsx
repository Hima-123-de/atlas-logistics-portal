  ...
  const getBlogPost = (postSlug: string | undefined) => {
    const posts = {
      'improve-carrier-relationships': {
        ...
        image: 'https://images.unsplash.com/photo-1586528116493-a029161edd50?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80',
        date: 'March 15, 2023',
